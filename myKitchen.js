const foodDo = [
  { name: "Chinese Rice",location: "Chinese", price: 25 ,qty :1,total:0},
  { name: "Doughnut & Ice-cream", location: "UK", price: 15,qty :1,total:0},
  { name: "Coffee",location: "Turkey", price: 10,qty :1,total:0},
  { name: "Moi-Moi",location: "Nigeria", price: 10,qty :1,total:0},
  { name: "Chicken & chips",location: "London ", price: 25 ,qty :1,total:0  },
  { name: "Snail",location: "Nigeria", price: 25 ,qty :1,total:0 },
  { name: "fried-rice",location: "Nigeria", price: 15 ,qty :1,total:0},
  { name: "Pizza", location: "London", price: 100 ,qty :1,total:0},
  { name: "Assorted- Fish",location: "japan", price: 100 ,qty :1,total:0},
     ...
     for (let index = 0; index < foodDoo.length; index++) {
       foodTable.innerHTML += `<tr>
                             ...
                             <td>${[index + 1]}</td>
                              ...
                              <td><button onclick="decrement(${foodDoo[index].id})">-</button><span1 id = "count">${foodDoo[index].qty}</span1><button onclick="increment(${foodDoo[index].id})">+</button></td>
